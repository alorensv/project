...
return [
    ...
    | ajustar cualquiera de estos mensajes aquí.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Puedes especificar mensajes de validación personalizados para atributos 
    | usando la convención "attribute.rule" para nombrar las líneas. Esto 
    | permite definir mensajes específicos para una regla y atributo dados.
    |
    */
    ...
    | marcadores de atributos con algo más legible, como "Dirección de 
    | correo electrónico" en lugar de "email". Esto ayuda a hacer los 
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Mensaje Global de Datos Inválidos
    |--------------------------------------------------------------------------
    */
