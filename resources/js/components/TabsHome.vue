...
<firmantes-modal :firmantes="firmantes"></firmantes-modal>
    ...
    <ul class="nav nav-tabs" id="documentTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="pendientes-tab" data-toggle="tab" href="#pendientes" role="tab" aria-controls="pendientes" aria-selected="true">Documentos con Firmas Pendientes</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="completados-tab" data-toggle="tab" href="#completados" role="tab" aria-controls="completados" aria-selected="false">Documentos Disponibles</a>
        </li>
    </ul>
