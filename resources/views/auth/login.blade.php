    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6 text-black mt-5">
                ...
                <div class="px-5 ms-xl-4 mt-5 centerAll">
                    ...
                    <span class="h1 fw-bold mb-0" style="width: 204px;">
                        <img class="w-100" src="https://tbl.transportesbulnes.cl/img/tbl/logo2.png" alt="">
                    </span>
                </div>
            ...
            <div class="col-sm-6 px-0 d-none d-sm-block">
                <img src="/img/tbl/services/login.png" alt="Login image" class="w-100 vh-100" style="object-fit: cover; object-position: left;">
            </div>
        </div>
    </div>
</section>
