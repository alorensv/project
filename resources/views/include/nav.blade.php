                                ...
                                @guest
                                    ...
                                    <li class="nav-item dropdown px-2 pt-1">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item {{request()->routeIs('web') ? 'active' : ''}}" href="{{ route('web') }}">{{ __('Diseño Web') }}
                                            </a>

                                            <a class="dropdown-item {{request()->routeIs('desarrollo') ? 'active' : ''}}" href="{{ route('desarrollo') }}">{{ __('Desarrollo de Software') }}
                                            </a>
